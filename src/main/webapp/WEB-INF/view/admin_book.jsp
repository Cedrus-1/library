                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        <div class="panel-heading">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <a  class="btn btn-primary" href="/admin/addBookPage" >添加</a>  点此添加一条数据
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" action="/admin/queryBook"  method="get">
                                <div class="row">
                                    <input hidden="hidden" name="pageNum" value="1"  />
                                    <input hidden="hidden" name="adminID" value=${user.adminID}  />
                        ...
                        <c:forEach var="book" items="${page.pageDatas}">
                            <tr>
                                ...
                                <td> <a class="btn btn-primary "  href="/admin/getBookInfo?bookID=${book.bookID}">修改</a>
                                    <a class="btn btn-primary "  href="/admin/borrowBookPage?bookID=${book.bookID}">借阅</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div align="center">
                        ...
                        <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=1">首页</a>

                            <c:choose>
                            <c:when test="${page.isHavePrePage}">
                                <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=${page.pageIndex - 1}">上一页</a>
                            </c:when>
                            <c:when test="${!page.isHavePrePage}">
                                <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=1">上一页</a>
                            </c:when>
                        </c:choose>
                        <c:choose>
                            <c:when test="${page.isHaveNextPage}">
                                <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=${page.pageIndex + 1}">下一页</a>
                            </c:when>
                            <c:when test="${!page.isHaveNextPage}">
                                <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=${page.totalPages}">下一页</a>
                            </c:when>
                        </c:choose>
                        <c:choose>
                            <c:when test="${page.totalPages==0}">
                                <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=${page.pageIndex}">尾页</a>
                            </c:when>
                            <c:otherwise>
                                <a class="btn btn-primary" href="/admin/queryBook?bookname=${bookquery.bookName}&auther=${bookquery.author}&publish=${bookquery.publish}&bookType=${bookquery.bookTypeID}&pageNum=${page.totalPages}">尾页</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
