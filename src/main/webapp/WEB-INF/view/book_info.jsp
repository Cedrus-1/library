                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                ...
                                <form class="form-horizontal" id="form_update" action="/admin/updateBookInfo" method="post" onsubmit="return checkUpdateForm()">
                                    <input type="hidden" id="update_bookId" name="bookID" value=${book.bookID} />
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input class="form-control" id="update_ISBN" name="ISBN" type="text" value="${book.ISBN}"  />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input class="form-control" id="update_totalNumber" name="totalNumber" type="text" value="${book.totalNumber}"  />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input class="form-control" id="update_nowNumber" name="nowNumber" type="text" value="${book.nowNumber}"  />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input class="form-control" id="update_borrowTimes" name="borrowTimes"  type="text" value="${book.borrowTimes}"  />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input class="form-control" id="update_rating" name="rating" type="text" value="${book.rating}"  />
