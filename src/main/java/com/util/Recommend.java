...
public class Recommend {
    ...
    public List<Book> getRecommendedBooksByUserID(int userID){
        ...
        //取后一页条数据
        if(recommendBooks!=null && recommendBooks.size()>Utils.PAGE_SIZE){
            List<BookTemp> bookTemps = recommendBooks.subList(recommendBooks.size()-Utils.PAGE_SIZE-1,recommendBooks.size()-1);
